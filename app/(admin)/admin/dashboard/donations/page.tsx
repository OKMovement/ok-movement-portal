  ...
  return (
    <>
      <header className="rounded-[8px] border border-black/10 bg-white px-6 py-6 shadow-[0_22px_38px_-24px_rgb(0_0_0/0.34)]">
        ...
        <h2 className="mt-3 text-3xl font-semibold text-brand-black">Donations</h2>
        <p className="mt-2 text-sm text-black/65">
          Verified Paystack payments, payment attempts, and material donation pledges. Only records marked Paid are confirmed payments.
        </p>
      </header>
