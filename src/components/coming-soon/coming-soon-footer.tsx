...
function SocialIcon({ platform }: { platform: SocialLink["platform"] }) {
  if (platform === "facebook") {
    return (
      <svg aria-hidden="true" className="h-4 w-4" viewBox="0 0 24 24">
        <path d="M14 8h3V5h-3c-2.9 0-5 2.1-5 5v3H7v3h2v5h3v-5h3l1-3h-4v-3c0-1.2.8-2 2-2z" fill="currentColor" />
      </svg>
    );
  }
  ...
  return (
    <svg aria-hidden="true" className="h-4 w-4" viewBox="0 0 24 24">
      <path d="m4 4 6.6 8.8L4.3 20H7l4.8-5.6L16 20h4L13 10.8 18.8 4H16l-4.2 4.9L8.3 4H4z" fill="currentColor" />
    </svg>
  );
}
