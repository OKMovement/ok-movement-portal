...
export default function ComingSoonHero({ canChangeSlide, onNextSlide }: ComingSoonHeroProps) {
  ...
  const movementDescriptionFirstStyled =
    keywordIndex === -1 ? (
      ...
      <>
        ...
        {HERO_CONTENT.movementDescriptionFirst.slice(keywordIndex + movementKeyword.length)}
      </>
    );
