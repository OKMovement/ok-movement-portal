...
export const SLIDES: SlideItem[] = [
  { id: "bg-one", src: "/images/bg-1.jpeg", alt: "" },
  { id: "bg-two", src: "/images/bg-2.jpeg", alt: "" },
  { id: "bg-three", src: "/images/bg-3.jpeg", alt: "" },
  { id: "bg-four5", src: "/images/bg-4.jpeg", alt: "" },
  { id: "bg-four6", src: "/images/bg-5.jpeg", alt: "" },
  { id: "bg-four7", src: "/images/bg-7.jpeg", alt: "" },
  { id: "bg-four8", src: "/images/bg-8.jpeg", alt: "" },
];
...
export const SOCIAL_LINKS: SocialLink[] = [
  { label: "Facebook", href: "https://www.facebook.com/share/1CYctYbA2m/?mibextid=wwXIfr", platform: "facebook" },
  { label: "Instagram", href: "https://www.instagram.com/p/DXM5eXZDKZ0/?igsh=ZWNpbmhudXJxdDJy", platform: "instagram" },
  { label: "YouTube", href: "https://www.youtube.com/@OKMediaChannel", platform: "youtube" },
  { label: "X (Twitter)", href: "https://x.com/OK2027movement", platform: "x" },
];
...
export const HERO_CONTENT = {
  ...
  movementCriteria: ["Character", "Competence", "Compassion", "Capacity", "Commitment"],
