...
export const aboutPrincipals = {
  "peter-obi": {
    ...
    gallery: [
      { src: "/images/bg-2.jpeg", alt: "Peter Obi and Rabiu Kwankwaso standing with supporters" },
      { src: "/images/bg-3.jpeg", alt: "Peter Obi marching with citizens at a democracy rally" },
    ],
    ...
    quote: "Leadership is service, and service must be measured by the lives it improves.",
    secondParagraphs: [
  ...
  "rabiu-kwankwaso": {
    ...
    gallery: [
      { src: "/images/bg-5.jpeg", alt: "Rabiu Kwankwaso seated with Peter Obi and public leaders" },
      { src: "/images/bg-8.jpeg", alt: "Rabiu Kwankwaso meeting with Peter Obi" },
    ],
    ...
    quote: "A stronger Nigeria begins when public leadership develops people, not just projects.",
    secondParagraphs: [
