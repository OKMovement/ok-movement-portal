  ...
  return (
    <div className="min-h-screen bg-[#f7f7f4] text-brand-black">
      <div className="mx-auto grid min-h-screen w-[min(100%-1.5rem,96rem)] gap-6 py-6 lg:grid-cols-[18rem_1fr]">
        <aside className="flex flex-col rounded-[18px] border border-black/10 bg-white p-5 shadow-[0_22px_38px_-24px_rgb(0_0_0/0.34)] lg:sticky lg:top-6 lg:h-[calc(100dvh-3rem)] lg:overflow-auto">
          <div>
          ...
          <div className="mt-auto pt-8">
            <div className="rounded-[12px] border border-black/10 bg-[#f7f7f4] p-3">
            ...
            <button
              ...
              className="mt-3 inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-[10px] bg-brand-black px-4 text-xs font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-brand-red"
            >
