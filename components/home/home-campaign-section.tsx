    ...
    >
      ...
      <div className="relative mx-auto w-[min(100%-1.5rem,82rem)] md:pr-16 lg:pr-24">
        ...
        <details className="group mx-auto mt-8 w-full max-w-2xl bg-white shadow-[0_18px_38px_rgb(0_0_0_/_0.12)] md:mt-10 xl:mt-12">
          <summary className="flex min-h-20 cursor-pointer list-none items-center justify-between gap-4 bg-brand-green px-5 text-left text-xl font-medium text-white transition hover:bg-brand-black [&::-webkit-details-marker]:hidden sm:px-7 sm:text-2xl">
